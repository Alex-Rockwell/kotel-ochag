<template>
      ...
      <div class="header__wrapper">
        ...
        <nav class="header__nav">
          <ul class="header__list" :class="{ footer__list_active: isActive }">
            ...
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'partners' }"
            >
              <RouterLink
                to="/partners"
                class="header__link"
            ...
            <li
              class="header__item"
              :class="{ activeLink: activeLink == 'library' }"
            >
              <RouterLink
                to="/library"
                class="header__link"
        ...
        <a
          href="https://www.instagram.com/servisgaz_ulyanovsk"
          class="header__instagram-link"
          target="_blank"
        >
          <img
            src="../../assets/images/instagram.svg"
            alt="Инстаграм"
            class="header__instagram-img"
          />
        </a>
        <a href="tel:88003330082" class="header__call header__call_basic">
          <marquee behavior="scroll" direction="left" scrollamount="7"
            >8 800 333 00 82</marquee
          >
          <span class="header__call-number">8 800 333 00 82</span>
        </a>
  ...
  <div v-if="activeLink != 'home'" class="banner-logo">
    ...
    />
    <h1 class="banner-logo__title">
      Отопительное оборудование высокого качества
    </h1>
  </div>
</template>
...
.header
    ...
    &__phone
        ...
        &::after
            ...
            width: 29px
            height: 29px
            background: url("../../assets/images/icon-header-call.svg") center no-repeat
