<template>
  <div class="shops container">
    <div class="shops__text-box">
      <div class="select">
        <h1 class="select-title">Где купить</h1>
        <CustomSelectMap
          @selected="
            (current) =>
      ...
      <div class="shops__text-container">
        ...
        >
          ...
          <h3 class="shopTime">Режим работы: {{ el.shopTime }}</h3>
...
const coords = ref([53.370108, 83.696188])

const markerText = ref('Газтеплотехника')
