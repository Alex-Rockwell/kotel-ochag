      ...
      <div class="footer__wrapper">
        ...
        <ul class="footer__list footer__list_1920">
          <li class="footer__item">
            <a href="/page/company.html" class="footer__sublist-title titleH4"
              >О компании</a
            >
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a href="/page/company.html#about" class="footer__sublist-link"
                  >О СЕРВИСГАЗ</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/company.html#partners"
                  class="footer__sublist-link"
                  >Партнёры</a
                >
              </li>
              <li class="footer__sublist-item">
                <a href="/page/company.html#news" class="footer__sublist-link"
                  >Новости</a
                >
              </li>
            </ul>
          ...
          <li class="footer__item">
            <a href="/catalog" class="footer__sublist-title titleH4"
              >Продукция</a
            >
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a href="/catalog" class="footer__sublist-link"
                  >Напольные котлы 1-контурные</a
                >
              </li>
              <li class="footer__sublist-item">
                <a href="/catalog" class="footer__sublist-link"
                  >Напольные котлы 2-контурные</a
                >
              </li>
              <li class="footer__sublist-item">
                <a href="/catalog" class="footer__sublist-link"
                  >Аппараты газовые 1-контурные</a
                >
              </li>
              <li class="footer__sublist-item">
                <a href="/catalog" class="footer__sublist-link"
                  >Аппараты газовые 2-контурные</a
                >
              </li>
              <li class="footer__sublist-item">
                <a href="/catalog" class="footer__sublist-link"
              ...
              <li class="footer__sublist-item">
                <a href="/page/spares.html" class="footer__sublist-link"
                  >Запчасти</a
                >
              </li>
            </ul>
          ...
          <li class="footer__item">
            <a href="/page/shops.html" class="footer__sublist-title titleH4"
              >Покупателям</a
            >
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a href="/page/shops.html" class="footer__sublist-link"
                  >Где купить?</a
                >
              </li>
            </ul>
          ...
          <li class="footer__item">
            ...
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a
                  href="/page/topartners.html#become-dealer"
                  class="footer__sublist-link"
                  >Стать дилером</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/topartners.html#become-service-centre"
                  class="footer__sublist-link"
                  >Стать сервисным центром</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/topartners.html#cooperation"
                  class="footer__sublist-link"
                  >Научное-техническое взаимодействие</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/topartners.html#advertising"
                  class="footer__sublist-link"
          ...
          <li class="footer__item">
            <a href="/page/service.html" class="footer__sublist-title titleH4"
              >Гарантия и сервис</a
            >
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a
                  href="/page/service.html#united-service"
                  class="footer__sublist-link"
                  >Единый центр технической поддержки</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/service.html#services"
                  class="footer__sublist-link"
                  >Сервисные центры</a
                >
              </li>
              <li class="footer__sublist-item">
                <a
                  href="/page/service.html#guarantee"
                  class="footer__sublist-link"
                  >Гарантийные документы</a
                >
              </li>
            </ul>
          </li>
          <li class="footer__item">
            <a href="/page/lib.html" class="footer__sublist-title titleH4"
              >Библиотека</a
            >
            <ul class="footer__sublist">
              <li class="footer__sublist-item">
                <a href="/page/lib.html" class="footer__sublist-link"
        ...
        <a href="tel:88003330082" class="footer__call">8 800 333 00 82</a>
        <a href="tel:88003330082" class="footer__phone">
      ...
      >
        <li class="footer__item">
          ...
          <ul class="footer__sublist">
            ...
            <li class="footer__sublist-item">
              <a href="/page/company.html#partners" class="footer__sublist-link"
                >Партнёры</a
              >
            </li>
            <li class="footer__sublist-item">
        ...
        <li class="footer__item">
          <a href="/page/catalogue.html" class="footer__sublist-title titleH4"
            >Продукция</a
          >
          <ul class="footer__sublist">
            <li class="footer__sublist-item">
              <a href="/page/catalogue.html#floor1" class="footer__sublist-link"
                >Напольные котлы 1-контурные</a
              >
            </li>
            <li class="footer__sublist-item">
              <a href="/page/catalogue.html#floor2" class="footer__sublist-link"
                >Напольные котлы 2-контурные</a
              >
            </li>
            <li class="footer__sublist-item">
              <a
                href="/page/catalogue.html#apparat1"
                class="footer__sublist-link"
                >Аппараты газовые 1-контурные</a
              >
            </li>
            <li class="footer__sublist-item">
              <a
                href="/page/catalogue.html#apparat2"
                class="footer__sublist-link"
                >Аппараты газовые 2-контурные</a
              >
            </li>
            <li class="footer__sublist-item">
              <a
                href="/page/catalogue.html#parapet"
                class="footer__sublist-link"
                >Парапетные котлы</a
              >
            </li>
            <li class="footer__sublist-item">
              <a href="#" class="footer__sublist-link">Запчасти</a>
            </li>
          </ul>
        </li>
        <li class="footer__item">
        ...
        <li class="footer__item">
          <a href="/page/topartners.html" class="footer__sublist-title titleH4"
            >Партнёрам</a
          >
          <ul class="footer__sublist">
            <li class="footer__sublist-item">
        ...
        <li class="footer__item">
          ...
          <ul class="footer__sublist">
            ...
            <li class="footer__sublist-item">
              <a href="/page/service.html#services" class="footer__sublist-link"
                >Сервисные центры</a
              >
            </li>
            <li class="footer__sublist-item">
        ...
        <li class="footer__item">
          ...
          <span class="footer__address"
            >432072, г. Ульяновск, 40-й проезд Инженерный, д. 16</span
          >
          <a href="tel:88003330082" class="footer__call_burger"
            >8 800 333 00 82</a
          >
          <a href="mailto:info@kotel-buran.ru" class="footer__mail"
            >info@kotel-buran.ru</a
          >
        </li>
      </ul>
    </div>
    ...
    .header
        ...
        &__phone
            ...
            &::after
                width: 17px
                height: 17px
                background: url(../img/main/icons/header-call-320.svg) center no-repeat
        &__list
            width: 100%
            z-index: 10
        &__hamburger
